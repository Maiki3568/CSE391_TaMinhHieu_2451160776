...
1. Khi bạn gõ https://shopee.vn vào trình duyệt và nhấn Enter , các 5 bước xảy ra từ DNS lookup đến render : 
...
Nguồn tham chiếu  :  01_introduction_html_universe.md + 1.1. Kiến trúc Client-Server — "Nhà hàng Online"



2. Trong DevTools của Chrome , tab Network cho thấy thông tin về requests/responses

![alt text](screeenshots/A1_2.png)
- Status Code request đầu tiên: 200
- Tổng thời gian load: Finish 3.64s
- File CSS: f4a8867675.css 

Nguồn tham chiếu  :  01_introduction_html_universe.md + 4.3. Developer Tools (F12) — "Kính hiển vi" cho website
---
...
+ <div class = "title">
+ <div class = "price">
+ <div class = "iphone.jpg"> <img src="iphone.jpg"></div>  Thiếu alt
+ <div class = "footer">

Sửa lại 8 lỗi semantic lần lượt  : 
...
<div class="title"> -> sửa thành <h2>
<div class="price"> -> sửa thành <p>
<div class="image"><img src="iphone.jpg"></div> -> sửa thành <div class="image"><img src="iphone.jpg" alt="iPhone 16 Pro"></div>
...
Nguồn tham chiếu  : 04_visible_part_html.md  + Semantic HTML5 — "Thẻ có ý nghĩa" 
---
...
Nguồn tham chiếu  : 04_visible_part_html.md  + Block vs Inline - Hai loại element cơ bản
...
<thead> là phần đầu bảng, chứa tiêu đề của các cột
<tbody> là phần thân bảng, chứa dữ liệu chính
<tfoot> là phần cuối bảng, thường dùng để hiển thị tổng kết hoặc thông tin bổ sung

Lí do không nên dùng table để tạo layout trang web:
+ Thứ nhất, thẻ <table> được thiết kế để biểu diễn dữ liệu dạng bảng (tabular data), vì vậy việc sử dụng cho mục đích bố cục (layout) là không đúng ngữ nghĩa (semantic).
+ Thứ hai, việc sử dụng <table> để xây dựng layout làm cấu trúc HTML trở nên phức tạp, lồng nhiều cấp (nested), gây khó khăn trong việc đọc hiểu và bảo trì mã nguồn.
+ Thứ ba, layout dựa trên <table> không linh hoạt và không hỗ trợ tốt thiết kế responsive, dẫn đến hiển thị kém trên các thiết bị có kích thước màn hình khác nhau, đặc biệt là thiết bị di động.
+ Thứ tư, các phương pháp hiện đại như CSS Flexbox và CSS Grid cung cấp khả năng xây dựng layout hiệu quả, linh hoạt và phù hợp hơn với tiêu chuẩn phát triển web hiện nay.
---
...
Lỗi 2: Dòng 4 — <title> không đóng thẻ — thêm </title>

Lỗi 3: Dòng 5 — charset sai (utf8) — sửa thành UTF-8

Lỗi 4: Dòng 9 — <h1> không đóng đúng — sửa thành </h1>

Lỗi 5: Dòng 13 — <a> không đóng thẻ — sửa thành </a>

Lỗi 6: Dòng 21 — <img> thiếu dấu ngoặc kép và alt — sửa thành <img src="iphone.jpg" alt="iPhone 16 Pro">

Lỗi 7: Dòng 23 — thẻ <b> lồng sai vị trí — sửa lại đúng nesting

Lỗi 8: Dòng 23 — nên dùng <strong> thay vì <b> (semantic)

Lỗi 9: Dòng 30 — bảng thiếu <thead>, <tbody> — bổ sung semantic table

Lỗi 10: Dòng 40 — dùng 2 thẻ <main> — sai (chỉ được 1) — đổi cái thứ 2 thành <aside>

Lỗi 11: Dòng 46 — <p> trong footer không đóng — thêm </p>

Lỗi 12: Thiếu thuộc tính lang trong <html> — thêm lang="vi"

---
Bài B4 (15đ) — Phân tích trang web thật
## Trả lời
Em chọn thegioididong.com

1. 
![alt text](screeenshots/B4_1.png)
...
2. ![alt text](screeenshots/B4_2.png)
Table trong trang hiển thị thông tin mô tả về loại điện thoại, cụ thể là hệ điều hành Android và các đặc điểm của nó như tính phổ biến và việc được nhiều hãng sử dụng.  
table này có sử dụng thẻ <tbody> và không có thẻ <thead>. 

3. ![alt text](screeenshots/B4_3.png)
...
Link video PBT01: https://www.youtube.com/watch?v=mJ4hm3HEk88